...
var lastNames = []string{
	...
	"宗", "曼", "紫", "逸", "贤", "蝶", "菡", "绿", "蓝", "儿", "翠", "烟", "小", "轩", "漫", "悠",
}
...
// GenerateName2Word 随机生成两字名字
func GenerateName2Word() string {
	return GetFirstName() + GetLastName()
}

// GenerateName2Word 随机生成三字名字
func GenerateName3Word() string {
	return GetFirstName() + GetLastName() + GetLastName()
}
